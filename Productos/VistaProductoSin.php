<?php
// SIN INICIAR SECION
include("../controlador/scripRegistro.php");
...
<body>
    <?php include("../nav/navPrincipal.php"); ?>
    <br>
    <div class="producto">
        <div class="imagen">
            <!-- <h2 align="right" >vendido</h2> -->
        ...
        <div class="info">
            ...
            <center>
                ...
                <form action="../vista/registrarseIngresar.php" onclick="return registrarse()" method="POST">
    ...
    ?>
        <div class = "galeria" >
            ...
            <div class = "datos">
                ...
                <form class="boton1" action="VistaProductoSin.php?id=<?php echo $mostrar['id']; ?>" method="POST" enctype="multipart/form-data">
