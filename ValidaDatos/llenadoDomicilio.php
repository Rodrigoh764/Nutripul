                ...
                <table border="1.5px">
                    <fieldset>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="numInterior" value="S/N"></td>
                            <td><input type="text" name="numExterior" value="S/N"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>rodrigoh764@gmail.com</td>
                            <td>55553717</td>
                            <td><select name="genero">
                                    <option value="Masculino Carranza">Masculino</option>
